#!/usr/bin/env python3
"""
Test script for Terminus1 agent analysis.

Usage:
  # Generate prompt only
  python tests/test_terminus1.py --run-dir /path/to/task --tasks-dir /path/to/tasks --mode prompt

  # Run full analysis
  python tests/test_terminus1.py --run-dir /path/to/task --tasks-dir /path/to/tasks --mode analyze \
...
from agents.terminus1.data_extractor import Terminus1DataExtractor
...
def main():
    parser = argparse.ArgumentParser(description="Test Terminus1 agent analysis")
    ...
    # Extract task data
    extractor = Terminus1DataExtractor(run_dir, tasks_dir)
    ...
    if args.mode == "prompt":
        ...
        output_dir = Path("./test_output_terminus1")
