#!/usr/bin/env python3
"""
Test script for Terminus2 agent analysis.

Usage:
  # Generate prompt only
  python tests/test_terminus2.py --run-dir /path/to/task --tasks-dir /path/to/tasks --mode prompt

  # Run full analysis
  python tests/test_terminus2.py --run-dir /path/to/task --tasks-dir /path/to/tasks --mode analyze \
...
from agents.terminus2.analyze_failures import AnalysisPromptBuilder, FailureAnalyzer
from src.llm_providers import get_provider
from src.output_generator import StreamingOutputGenerator


def main():
    parser = argparse.ArgumentParser(description="Test Terminus2 agent analysis")
    ...
    if args.mode == "prompt":
        ...
        output_dir = Path("./test_output_terminus2")
